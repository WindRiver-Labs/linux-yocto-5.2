...
__ETHTOOL_DECLARE_LINK_MODE_MASK(nxp_phy_basic_features) __ro_after_init;
#define NXP_PHY_BASIC_FEATURES ((unsigned long *)&nxp_phy_basic_features)

static const int nxp_phy_basic_ports_array[] = {
...
static struct phy_driver nxp_drivers[] = {
{
	...
	.features = NXP_PHY_BASIC_FEATURES,
	.flags = 0,
	.probe = &nxp_probe,
	.remove = &nxp_remove,
...
static int __init nxp_init(void)
{
	...
	linkmode_set_bit_array(nxp_phy_basic_ports_array,
			   ARRAY_SIZE(nxp_phy_basic_ports_array),
			   nxp_phy_basic_features);
